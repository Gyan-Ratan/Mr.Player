...
class Ui_MrPlayer(object):
    ...
    def retranslateUi(self, MrPlayer):
        ...
        self.RemainingTimeDisplay.setToolTip(
            _translate("MrPlayer", "<html><head/><body><p>Total Time</p></body></html>"))
        self.RemainingTimeDisplay.setText(_translate("MrPlayer", "00:00"))
        self.OpenFiles.setToolTip(
            _translate("MrPlayer", "<html><head/><body><p>Open Songs</p><p>Shortcut: Alt+O</p></body></html>"))
